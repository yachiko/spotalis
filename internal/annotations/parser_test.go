		...
		Context("with invalid annotations", func() {
			It("should fail with invalid spot percentage", func() {
				obj := &MockObject{
					...
					annotations: map[string]string{
						SpotPercentageAnnotation: testInvalid,
					},
				}
			...
			It("should fail with invalid spot percentage", func() {
				obj := &MockObject{
					...
					annotations: map[string]string{
						SpotPercentageAnnotation: testNotANumber,
					},
				}
			...
			It("should fail with invalid min-on-demand", func() {
				obj := &MockObject{
					...
					annotations: map[string]string{
						MinOnDemandAnnotation: testNotANumber,
					},
				}
